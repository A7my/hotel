...
class CafeAndRestController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/cafeAndRest');
    }
