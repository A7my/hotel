...
<head>
  ...
  <!-- Favicons -->
  <link href="{{URL::asset('website_assets/assets/img/LOGO.jpg')}}" rel="icon">
  <link href="{{URL::asset('website_assets/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Roboto:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="{{URL::asset('website_assets/assets/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/aos/aos.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/cafe/assets/css/style.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/cafe/assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/cafe/assets/vendor/aos/aos.css')}}" rel="stylesheet">
  <link href="{{URL::asset('website_assets/assets/cafe/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{URL::asset('website_assets/assets/css/style.css')}}" rel="stylesheet">
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      ...
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Call us now {{$Contacts->phone}}
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{url('hotel')}}" class="logo me-auto"><img src="{{URL::asset('website_assets/assets/img/LOGO.jpg')}}" alt=""></a>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 --><?php $kk = $home->image;?>
        <div class="carousel-item active" style="background-image: url(http://127.0.0.1:8000/website_assets/assets/img/slide/{{$home->image}})">
          <div class="container">
            <h2>{{$home->title}}</h2>
            <p>{{$home->bio}}</p>
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(http://127.0.0.1:8000/website_assets/assets/img/slide/slide-2.jpg)">
          <div class="container">
            <h2>Service</h2>
            <p>
              Service
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(http://127.0.0.1:8000/website_assets/assets/img/slide/slide-3.jpg)">
          <div class="container">
            <h2>Success</h2>
            <p>
              Success
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="{{$map->url}}" frameborder="0" allowfullscreen></iframe>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Email Us</h3>
                  <p>{{$Contacts->email}}<br>{{$Contacts2->email}}</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Call Us</h3>
                  <p>{{$Contacts->phone}}<br>{{$Contacts2->phone}}</p>
                </div>
              </div>
            </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        ...
        <br>
              ...
              <div class="social-links mt-3">
                <a href="{{$Contacts_urls->twitter}}" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="{{$Contacts_urls->facebook}}" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="{{$Contacts_urls->insta}}" class="instagram"><i class="bx bxl-instagram"></i></a>
                <a href="{{$Contacts_urls->skype}}" class="google-plus"><i class="bx bxl-skype"></i></a>
                <a href="{{$Contacts_urls->linkedin}}" class="linkedin"><i class="bx bxl-linkedin"></i></a>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>{{$about->nameOfHotel}}</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
